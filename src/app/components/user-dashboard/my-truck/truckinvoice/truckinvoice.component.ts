...
@Component({
  selector: 'app-truckinvoice',
  templateUrl: './truckinvoice.component.html',
  styleUrls: ['./truckinvoice.component.css']
})
export class TruckinvoiceComponent implements OnInit {

  users = [];
  currUser;

  constructor(
    public dialogRef: MatDialogRef<TruckinvoiceComponent>,
