...
@Component({
  selector: 'app-packerinvoice',
  templateUrl: './packerinvoice.component.html',
  styleUrls: ['./packerinvoice.component.css']
})
export class PackerinvoiceComponent implements OnInit {
  users = [];
  currUser;

  constructor(
    public dialogRef: MatDialogRef<PackerinvoiceComponent>,
