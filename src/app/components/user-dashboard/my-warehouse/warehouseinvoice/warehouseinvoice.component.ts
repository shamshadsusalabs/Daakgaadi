...
@Component({
  selector: 'app-warehouseinvoice',
  templateUrl: './warehouseinvoice.component.html',
  styleUrls: ['./warehouseinvoice.component.css']
})
export class WarehouseinvoiceComponent implements OnInit {
  users = [];
  currUser;

  constructor(
    public dialogRef: MatDialogRef<WarehouseinvoiceComponent>,
