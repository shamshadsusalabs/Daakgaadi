...
@Component({
  selector: 'app-domesticpacker',
  templateUrl: './domesticpacker.component.html',
  styleUrls: ['./domesticpacker.component.css']
})
export class DomesticpackerComponent implements OnInit {
