...
@Component({
  selector: 'app-biketrans',
  templateUrl: './biketrans.component.html',
  styleUrls: ['./biketrans.component.css']
})
export class BiketransComponent  {
...
console.log(box);
    ...
    this.updateTotalValues();
      ...
      this.http
          .post('https://inspiring-being-405110.el.r.appspot.com/mail/sendmail/first',dataToSave)
          .subscribe(
            (response) => {
