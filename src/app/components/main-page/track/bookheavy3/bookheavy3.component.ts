...
@Component({
  selector: 'app-bookheavy3',
  templateUrl: './bookheavy3.component.html',
  styleUrls: ['./bookheavy3.component.css']
})
export class Bookheavy3Component implements OnInit {
...
calcRoute() {
  ...
  directionsService.route(request, (result: { routes: { legs: { distance: any; duration: { text: any; }; }[]; }[]; }, status: any) => {
    if (status === google.maps.DirectionsStatus.OK) {
      ...
      this.http.post('https://inspiring-being-405110.el.r.appspot.com/mail/sendmail/third/fulltruck7', {
                email: email,
                number: number,
                name:name,
