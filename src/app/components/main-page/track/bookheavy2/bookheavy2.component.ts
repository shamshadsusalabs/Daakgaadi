...
@Component({
  selector: 'app-bookheavy2',
  templateUrl: './bookheavy2.component.html',
  styleUrls: ['./bookheavy2.component.css']
})
export class Bookheavy2Component implements OnInit {
...
calcRoute() {
  ...
  directionsService.route(request, (result: { routes: { legs: { distance: any; duration: { text: any; }; }[]; }[]; }, status: any) => {
    if (status === google.maps.DirectionsStatus.OK) {
      ...
      this.http.post('https://inspiring-being-405110.el.r.appspot.com/mail/sendmail/third/fulltruck6', {
                email: email,
                number: number,
                name:name,
