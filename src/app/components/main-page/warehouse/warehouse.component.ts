...
export class WarehouseComponent  {
  ...
  area1: string = '';
  location1: string = '';
  confirmationMessage: string = ''; // Initialize confirmation message
  ...
  sendConfirmationEmail1() {
    ...
    this.http.post('https://inspiring-being-405110.el.r.appspot.com/mail/sendmail/warehouseStorage', emailData).subscribe(
      (response) => {
  ...
  // Use value property to get the input value
        ...
        this.http.post<any>('https://trekkowave.el.r.appspot.com/api/addwarehouse', estimateData).subscribe(
          (response: any) => {
